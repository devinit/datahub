...
const withData = graphql(QUERY, {
  ...
  props: ({data, ownProps}) => {
    ...
    const [points] = [
      [
        objectify((data.bubbleChartOda && data.bubbleChartOda.revenuePerPerson) || [], d => `${d.year}-${d.id}`),
        objectify((data.bubbleChartOda && data.bubbleChartOda.numberInExtremePoverty) || [], d => `${d.year}-${d.id}`),
      ...
      return Object
        ...
        .filter(d =>
          ...
          typeof d.numberInExtremePoverty === 'number'
        );
    });
