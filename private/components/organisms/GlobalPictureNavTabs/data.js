...
export default {
  globalPictureThemes: [
    ...
    },
    {
      ...
      name: 'Vulnerability',
      indicators: [
        { id: 'data_series.fragile_states', name: 'Fragile states' },
        {
    ...
    },
    {
      ...
      indicators: [
        { id: 'data_series.in_ha', name: 'Humanitarian assistance' }
      ],
    ...
    },
    {
      ...
      indicators: [
        ...
        { id: 'data_series.stat_capacity', name: 'Statistical capacity' }
      ],
    ...
    },
    {
      ...
      indicators: [
        { id: 'data_series.iati_budgets_gb', name: 'UK, DFID planned budgets' },
        {
