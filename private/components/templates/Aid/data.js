...
const data = {
  toolBar: {
    ...
    forms: [
      ...
      {name: 'Global initiatives and northern non-governmental organisations', value: 'Global initiatives and northern non-governmental organisations'},
    ...
    channels: [
      ...
      {name: 'Other (private sector, think-tank, etc.)', value: 'Other (private sector, think-tank, etc.)'},
      ...
      {name: 'Public sector (recipient government)', value: 'Public sector (recipient government)'},
