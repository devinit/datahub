    ...
    <Container>
      <Grid>
        <Grid.Column computer={5} tablet={16} mobile={16}>
          ...
          <PTag size={'big'} fontWeight={'bold'}>{props.overViewTabRegional.poorestPeople}</PTag>
        </Grid.Column>
        ...
        <Grid.Column computer={5} tablet={16} mobile={16}>
          ...
          <PTag size={'big'} fontWeight={'bold'}>${props.overViewTabRegional.regionalResources}</PTag>
        </Grid.Column>
        ...
        <Grid.Column computer={5} tablet={16} mobile={16}>
          ...
          <PTag size={'big'} fontWeight={'bold'}>{props.overViewTabRegional.localGovernmentSpendPerPerson}</PTag>
        </Grid.Column>
      </Grid>
    </Container>
  );
