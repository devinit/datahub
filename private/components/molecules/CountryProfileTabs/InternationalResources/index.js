    ...
    <Container>
      <Grid>
        <Grid.Column computer={5} tablet={16} mobile={16}>
          ...
          <PTag size={'big'} fontWeight={'bold'} color={red}>{props.internationalResources.netODAOfGNIIn } of GNI</PTag>
          <PTag>Gross national income is {props.internationalResources.GNI}</PTag>
        </Grid.Column>
