...
export default class PrintTreeChart extends React.Component<Props, State> {
    ...
    return (
      <Container>
        <Grid style={ { paddingBottom: '40px' } }>
          <Grid.Column mobile={ 16 } computer={ 16 } width={ 16 } style={ { padding: 0 } }>
            { this.renderTreeChart(tree) }
          </Grid.Column>
        </Grid>
      </Container>
    );
  ...
  private renderTreeChart(tree: TreeObj[]) {
    if (tree.length) {
