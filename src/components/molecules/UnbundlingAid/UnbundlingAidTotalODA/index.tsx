...
import { black, primaryColor, white } from '../../../theme/semantic';
    ...
    <div style={ { position: 'relative' } }>
      <Container>
        ...
        <Header as="h5">
          {
            props.aidType === 'oda' ?
              'Official development assistance (total gross disbursements, 2016 prices)'
              :
              'Total other official flows (non export credit) (total gross disbursements, 2016 prices)'
          }
        </Header>
