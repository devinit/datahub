  ...
  public render() {
    ...
    return (
      <React.Fragment>
        <Grid>
          <Grid.Column width={ 8 }>
            <Segment basic clearing style={ { paddingLeft: 0 } }>
              <SectionHeader
                color="#fff"
                style={ { fontSize: '9px', float: 'right', marginRight: '47px', paddingLeft: 0, paddingRight: 0 } }
              >
                {
          ...
          <Grid.Column width={ 8 } style={ { paddingRight: 0 } }>
            <Segment basic clearing style={ { paddingRight: 0 } }>
              <SectionHeader
                color="#fff"
                style={ { fontSize: '9px', float: 'left', marginLeft: '45px', paddingLeft: 0, paddingRight: 0 } }
              >
                { countryType !== RECIPIENT || blacklist.includes(country) ?
