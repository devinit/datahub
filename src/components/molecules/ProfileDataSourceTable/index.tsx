...
const updateGoogleAnalytics = (item: any, category: 'CSV' | 'ZIP') => {
                ...
                { data.map(item =>
                  (<Table.Row key={ item.name }>
                    ...
                    <Table.Cell>
                      {
                        noDownloads ?
                          <ToolTip trigger={ <span><Icon name="file" />CSV</span> }>
                          ...
                          <span>
                            <a
                              ...
                              onClick={ () => updateGoogleAnalytics(item, 'ZIP') } // tslint:disable-line
                            >
                              <Icon name="file" />ZIP
                            </a>
                            <a
                              ...
                              target="__blank"
                              rel="noopener"
                              onClick={ () => updateGoogleAnalytics(item, 'CSV') } // tslint:disable-line
                            >
                              <Icon name="file" />CSV
                            </a>
                          </span>
