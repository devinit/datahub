  ...
  methodology: [
    {
      ...
      description:
        'The percentage of population of each country who are in the global poorest 20%. 2015 represents the most recent year data is available',
      methodology: '',
      uom: 'percent',
      csv:
    ...
    },
    {
      ...
      description:
        'The year of the last agricultural (crop and/or livestock) census or survey',
      methodology: '',
      uom: '',
      csv:
    ...
    },
    {
      ...
      description:
        'Poverty surveys collect data on household income, consumption and expenditure, including income in kind. They typically include income, expenditure, and consumption surveys, household budget surveys, Integrated Surveys, Living Standard Measuring Surveys, and other poverty related surveys',
      methodology: '',
      uom: '',
      csv:
    ...
    },
    {
      ...
      description:
        'The percentage of births reported in vital statistics where the data is derived from the Civil Registration system',
      methodology: '',
      uom: '',
      csv:
    ...
    },
    {
      ...
      description:
        'The percentage of deaths reported in vital statistics where the data is derived from the Civil Registration system',
      methodology: '',
      uom: '',
      csv:
    ...
    },
    {
      ...
      description:
        'A national administrative system recording data from all education facilities on staff, logistics, performance etc',
      methodology: '',
      uom: '',
      csv:
      ...
      source: {
        ...
        link:
          "'www.unicef.org/about/annualreport/index_82089.html; www.poledakar.com/dqaf/index.php?title=DQAF_Events'"
      }
    },
    {
    ...
    },
    {
      ...
      description:
        'The year and type of the last national household survey. Standard survey types: Demographic & Health Survey (DHS); Multiple Indicator Cluster Survey (MICS); Household Income & Expenditure Survey (HIES); National Survey (NS)',
      methodology: '',
      uom: '',
      csv:
    ...
    },
    {
      ...
      description:
        'A national administrative system recording data from all health facilities on staff, logistics, performance, morbidity etc',
      methodology: '',
      uom: '',
      csv:
