...
export interface UnbundlingAidToTalQuery {
  // oda or oof
  aidType: string,
  year?: number | null,
};
...
export interface DifferentProvidersDifferentPriotitiesQuery {
  bubbleChartOptions:  {
...
export interface BubbleChartIndicatorListQuery {
  bubbleChartOptions:  {
    // this list feeds off oda table from countries and global/concept file
    // IdNamePair is defined in unbundling aid types
    indicators:  Array< {
...
export interface DistrictsQueryVariables {
  country: string,
};
...
export interface GlobalPictureThemesQuery {
...
export interface InfowsVsOutflowsQueryVariables {
  donor: string,
  recipient: string,
};

export interface InfowsVsOutflowsQuery {
...
export interface ResourcesOverTimeToolTipQueryVariables {
  id: string,
};

export interface ResourcesOverTimeToolTipQuery {
  internationalResources:  {
    // for sidebar chart in international resources section & area partition tree chart default data
    resourcesOverTime:  {
      toolTip:  {
...
export interface MethodologyQueryVariables {
  moduleName: string,
};
...
export interface SpotlightThemesQueryVariables {
  country: string,
};

export interface SpotlightThemesQuery {
...
export interface UnbundlingAidCacheQueryVariables {
  aidType: string,
  args?: UnbundlingAidToTalQuery | null,
};

export interface UnbundlingAidCacheQuery {
  selections:  {
